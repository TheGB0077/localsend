...
mixin FileMetadataMappable {
  ...
  FileMetadataCopyWith<FileMetadata, FileMetadata, FileMetadata> get copyWith => _FileMetadataCopyWithImpl<FileMetadata, FileMetadata>(
        this as FileMetadata,
        $identity,
        $identity,
      );
...
extension FileMetadataValueCopy<$R, $Out> on ObjectCopyWith<$R, FileMetadata, $Out> {
  FileMetadataCopyWith<$R, FileMetadata, $Out> get $asFileMetadata => $base.as((v, t, t2) => _FileMetadataCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _FileMetadataCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, FileMetadata, $Out> implements FileMetadataCopyWith<$R, FileMetadata, $Out> {
  ...
  @override
  $R call({Object? lastModified = $none, Object? lastAccessed = $none}) => $apply(
        FieldCopyWithData({
