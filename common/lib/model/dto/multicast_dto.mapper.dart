...
class MulticastDtoMapper extends ClassMapperBase<MulticastDto> {
  ...
  static String? _$irohTicket(MulticastDto v) => v.irohTicket;
  static const Field<MulticastDto, String> _f$irohTicket = Field(
    'irohTicket',
    _$irohTicket,
  );
  static bool? _$irohCapable(MulticastDto v) => v.irohCapable;
  static const Field<MulticastDto, bool> _f$irohCapable = Field(
    'irohCapable',
    _$irohCapable,
  );
  ...
  static MulticastDto _instantiate(DecodingData data) {
    return MulticastDto(
      ...
      irohTicket: data.dec(_f$irohTicket),
      irohCapable: data.dec(_f$irohCapable),
    );
  }
...
class _MulticastDtoCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, MulticastDto, $Out> implements MulticastDtoCopyWith<$R, MulticastDto, $Out> {
  ...
  $R call({
    ...
    Object? irohTicket = $none,
    Object? irohCapable = $none,
  }) =>
      $apply(
        FieldCopyWithData({
          ...
          if (irohTicket != $none) #irohTicket: irohTicket,
          if (irohCapable != $none) #irohCapable: irohCapable,
        }),
      );
  @override
  MulticastDto $make(CopyWithData data) => MulticastDto(
        ...
        irohTicket: data.get(#irohTicket, or: $value.irohTicket),
        irohCapable: data.get(#irohCapable, or: $value.irohCapable),
      );
