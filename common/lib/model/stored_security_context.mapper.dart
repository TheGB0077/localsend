...
mixin StoredSecurityContextMappable {
  ...
  StoredSecurityContextCopyWith<StoredSecurityContext, StoredSecurityContext, StoredSecurityContext> get copyWith =>
      _StoredSecurityContextCopyWithImpl<StoredSecurityContext, StoredSecurityContext>(this as StoredSecurityContext, $identity, $identity);
  @override
  String toString() {
...
extension StoredSecurityContextValueCopy<$R, $Out> on ObjectCopyWith<$R, StoredSecurityContext, $Out> {
  StoredSecurityContextCopyWith<$R, StoredSecurityContext, $Out> get $asStoredSecurityContext => $base.as(
